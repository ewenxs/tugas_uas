      ...
      <form action="/kegiatan/{{ $kegiatan->id }}" method="POST">
        ...
        <div class="mb-3">
          ...
          <select class="livesearch_bagian form-select  @error('bagians') is-invalid @enderror" name="bagian_id">
            ...
            <option value="{{$bagian->bagian_id}}" @if($bagian->bagian_id === $kegiatan->bagian_id) selected="selected"
        ...
        <div class="mb-3">
          ...
          <input name="kode_kegiatan" type="text" class="form-control" id="basic-default-fullname"
            value="{{ $kegiatan->kode_kegiatan }}">
        </div>
        <div class="mb-3">
          <label class="form-label" for="basic-default-fullname">Nama Kegiatan</label>
          <input name="nama_kegiatan" type="text" class="form-control" id="basic-default-fullname"
