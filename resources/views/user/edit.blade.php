    ...
    <div class="card-body">
      ...
      <form action="/user/{{ $user->id }}" method="POST">
        ...
        <div class="mb-3">
          ...
          <input name="name" type="text" class="form-control" id="basic-default-fullname" value="{{ $user->name }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input name="email" type="text" class="form-control" id="basic-default-fullname" value="{{ $user->email }}">
        </div>
        <div class="mb-3">
          ...
          <select class="form-select" id="role" name="role" aria-label="Default select example">
            ...
            <option value="{{$user->role}}" @if($user->role === $user->role)
              selected="selected" @endif>{{$user->role}}</option>
          </select>
        </div>
        <div class="mb-3">
