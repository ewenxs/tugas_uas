      ...
      <div class="card-body">
          ...
          <form action="/rekening/{{ $rekening->id }}" method="POST">
            ...
            <div class="mb-3">
              ...
              <input name="no_rekening" type="text" class="form-control" id="basic-default-fullname" value="{{ $rekening->no_rekening }}">
            </div>
            <div class="mb-3">
              <label class="form-label" for="basic-default-fullname">Nama Rekening</label>
              <input name="nama_rekening" type="text" class="form-control" id="basic-default-fullname" value="{{ $rekening->nama_rekening }}">
            </div>
