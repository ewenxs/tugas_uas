      ...
      <div class="card-body">
          ...
          <form action="/sub_kegiatan/{{ $sub_kegiatan->id }}" method="POST">
            ...
            <div class="mb-3">
              ...
              <input name="kode_sub_kegiatan" type="text" class="form-control" id="basic-default-fullname" value="{{ $sub_kegiatan->kode_sub_kegiatan }}">
            </div>
            <div class="mb-3">
              <label class="form-label" for="basic-default-fullname">Nama Sub Kegiatan</label>
              <input name="nama_sub_kegiatan" type="text" class="form-control" id="basic-default-fullname" value="{{ $sub_kegiatan->nama_sub_kegiatan }}">
            </div>
            <div class="mb-3">
